...
{
    public partial class RadiationSiteListPage : ContentPage
    {
        ...
        //辐射
        public RadiationSiteListPage()
        {
            InitializeComponent();
            NavigationPage.SetBackButtonTitle(this, "");
            this.Title = App.moduleConfigENVQ.menuRadiationLabel;
        ...
        private async void ReqVOCSite()
        {
            ...
            if (hTTPResponse.StatusCode == System.Net.HttpStatusCode.OK)
            {
                try
                {
                    ...
                    if (total != 0) Title = App.moduleConfigENVQ.menuRadiationLabel + "（" + total + "）";
                    else Title = App.moduleConfigENVQ.menuRadiationLabel;
                }
                catch (Exception ex)
                {
