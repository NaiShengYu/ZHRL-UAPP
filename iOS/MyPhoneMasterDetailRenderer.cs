...
namespace AepApp.iOS
{
    public class MyPhoneMasterDetailRenderer : UIViewController, IVisualElementRenderer, IEffectControlProvider
    {
        ...
        public void SetElement(VisualElement element)
        {
            ...
            widthRatio = ((MasterAndDetailPage)element).WidthRatio;
        ...
        void UpdateMasterDetailContainers()
        {
            ...
            var masterRenderer = Xamarin.Forms.Platform.iOS.Platform.GetRenderer(((MasterDetailPage)Element).Master);
            var detailRenderer = Xamarin.Forms.Platform.iOS.Platform.GetRenderer(((MasterDetailPage)Element).Detail);
